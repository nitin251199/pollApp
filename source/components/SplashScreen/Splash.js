    ...
    if (response.success === true) {
      ...
      if (user_data.approval_status == "Approved") {
        ...
        if (user_data.profile_completed == "Completed") {
          ...
          Toast.show(
            "Please complete your profile to continue using App with better performance."
          );
        ...
        Toast.show(
          "Your profile status is currently " +
            ...
            ", Please wait untill admin approved your prifle, after that you can log in into the App."
        );
        this.props.navigation.replace("MainScreen"); //MainScreen
      }
    } else {
