...
import { Text, View, Image, Animated, ImageBackground, StyleSheet, ScrollView,Platform } from 'react-native';
        ...
        <View style={{ paddingHorizontal: 20, flex: 1 }}>
          ...
          <View style={{ marginBottom: 15 }}>
            <Button
              ...
              mode="contained" onPress={() => { this.props.navigation.navigate('Zone') }}>
          ...
          <View style={{ marginBottom: 15 }}>
            <Button
              ...
              mode="contained" onPress={() => { this.sync_local_to_server() }}  >
          ...
          <View style={{ marginBottom: 45 }}>
            <Button
              ...
              mode="contained" onPress={() => { this.sync_data_from_live() }}  >
