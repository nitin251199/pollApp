...
import { Text, View, Image, Animated, ImageBackground, StyleSheet, ScrollView,Platform,Alert } from 'react-native';
      ...
      <View style={styles.container}>
        <View style={{ paddingHorizontal: 20, flex: 1 }}>
          <View style={{ alignItems: 'center', marginBottom: 20 }}>
            ...
            <View style={{ backgroundColor: '#0b353c', borderRadius: 5, height: 100, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 50, marginTop: 50 }}>
              <Text style={{ fontWeight: 'bold', fontSize: 20, color: '#fff' }}>Insterted Records: <Text style={{ color: 'red' }}>{this.state.total_sample}</Text></Text>
            </View>
          </View>
        ...
        <>
          ...
          <View style={{ marginBottom: 15 }}>
            <Button
              ...
              mode="contained" onPress={() => { this.props.navigation.navigate('Question') }}>
          ...
          <Button
            ...
            contentStyle={{ flexDirection: 'row-reverse', backgroundColor: '#aba8a7', height: 55, }}
            mode="contained" onPress={() => { this.app_not_ready() }}>
            <Title style={{ color: '#fff' }}> नया सैंपल (Not Ready) </Title>
          </Button>
          </View>
          }
          ...
          <View style={{ marginBottom: 15 }}>
            <Button
              ...
              contentStyle={{ flexDirection: 'row-reverse', backgroundColor: '#0b353c', height: 55, }}
              mode="contained" onPress={() => { this.try_sync_data_server() }}  >
              <Title style={{ color: '#fff' }}> अपलोड करें - Pending-{this.state.total_pending} </Title>
            </Button>
          ...
          <View style={{ marginBottom: 15 }}>
            <Button
              ...
              contentStyle={{ flexDirection: 'row-reverse', backgroundColor: '#1e71f7', height: 55, }}
              mode="contained" onPress={() => {  this.props.navigation.navigate('Pendinglist') }}  >
              <Title style={{ color: '#fff' }}> Review Pending survey -{this.state.total_pending} </Title>
            </Button>
          ...
          <View style={{ marginBottom: 15 }}>
            <Button
              contentStyle={{ flexDirection: 'row-reverse', backgroundColor: '#f52754', height: 55, }}
               onPress={() => { this.alert_for_refresh() }}  >
              <Title style={{ color: '#fff' }}>Zone: {this.state.user_zone_data.name} ( {this.state.user_zone_data.code} )</Title>
            </Button>
     ...
     this.state.member_role == 'QC' || this.state.member_role == 'ZC' ?
      ...
      <View style={{ marginBottom: 15 }}>
            <Button
              ...
              contentStyle={{ flexDirection: 'row-reverse', backgroundColor: '#25904f', height: 55, }}
              mode="contained" onPress={() => { this.props.navigation.navigate('Members') }}>
              
              {
                this.state.member_role == 'QC' ?
              <Title style={{ color: '#fff' }}> Z.C. Accounts : {this.state.zc_count} </Title>
              :
              <Title style={{ color: '#fff' }}> O.T. Accounts : {this.state.zc_count} </Title>
              }
...
<View style={{ marginBottom: 45 }}>
            <Button
              contentStyle={{ flexDirection: 'row-reverse', backgroundColor: 'red', height: 55, }}
               onPress={() => { this.logout() }}  >
          ...
          <View style={{ marginBottom: 45 }}>
            <Button
              contentStyle={{ flexDirection: 'row-reverse', backgroundColor: '#11024f', height: 55, }}
               onPress={() => {  this.props.navigation.navigate('Notifications') }}  >
                 {
                   this.state.new_count == 0 ?
              <Title style={{ color: '#fff' }}>Notifications  </Title>
              :
              <Title style={{ color: 'red' }}>Notifications ({this.state.new_count}) </Title>
                 }
            </Button>
